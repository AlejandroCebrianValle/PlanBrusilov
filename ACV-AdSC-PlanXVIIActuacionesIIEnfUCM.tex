...
\fancyhead[L]{Manual Actuaciones para II Grado en Enfermería}
\fancyfoot{}
\fancyfoot[C]{\thepage}
...
\begin{document}
	...
	%\part{Introducción}
	% SEC I - Seminario
	\input{./secciones/ACV-UCMRot-IIEnfermeriaParteA}
	\clearpage
	% SEC II - Guia para los seminarios
	\input{./secciones/ACV-UCMRot-IIEnfermeriaParteBGuiaSem}
	\input{./secciones/ACV-UCMRot-IIEnfermeriaParteBCasos}
	% SEC III - Rúbricas
	\input{./secciones/ACV-UCMRot-IIEnfermeriaParteBRubrica}
	\input{./secciones/ACV-UCMRot-IIEnfermeriaParteBRubricaElsevier}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	%APPENDICES
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	%\part*{Apendices}
